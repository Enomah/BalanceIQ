    ...
    const insights: Record<string, string> = {
      food:
        percentage > 30
          ...
          : "Good balance on food spending",
      transport:
        percentage > 20
          ? "Explore cost-effective transportation options"
          : "Transportation spending is reasonable",
      accommodation:
        percentage > 40
          ? "Housing is your largest expense - consider options"
          : "Housing costs are well managed",
      entertainment:
        percentage > 15
          ? "Entertainment spending might be high"
          : "Entertainment budget looks good",
      shopping:
        percentage > 25
          ? "Watch impulse purchases in shopping"
          : "Shopping habits are controlled",
    };
  ...
  return (
    <div className="bg-[var(--primary-50)] dark:bg-[var(--primary-900)] p-4 rounded-lg">
      ...
      <p className="text-sm text-white/70 mb-2">
        Your top spending category is <strong>{topCategory.name}</strong> at{" "}
